s/\{@\s*?(\S+)\s*?!=\s*?(\\\"|'){2}\s*?@\}/{@ \1 is defined and \1 != '' @}/
s/\{@\s*?(\S+)\s*?!=\s*?(\\\"|'){2}\s*?and\s*?(\S+)\s*?!=\s*?(\\\"|'){2}\s*?@\}/{@ \1 is defined and \1 != '' and \2 is defined and \2 != '' @}/
s/\{%\s*?if (\S+)\s*?!=\s*?(\\\"|'){2}\s*?%\}/{% if \1 is defined and \1 != '' %}/g
s/\{%\s*?if (\S+)\s*?==\s*?(\\\"|'){2}\s*?%\}/{% if not \1 %}/g
s/\{@\s*?(\S+)\s*?==\s*?(\\\"|'){2}\s*?@\}/{@ not \1 @}/
